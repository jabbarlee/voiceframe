...
const steps = [
  ...
  {
    name: "Get Transcript",
    description: "Our AI transcribes your audio with timestamps and speaker identification.",
    icon: Mic,
  },
  {
    name: "Generate Content",
    description: "Choose from multiple content formats and let AI create the first draft.",
    icon: FileText,
  },
  {
    name: "Edit & Share",
    ...
    <section id="how-it-works" className="w-full bg-muted/50 py-24">
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">How VoiceFrame Works</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Turn your spoken words into polished content in just a few simple steps.
          </p>
        </div>
